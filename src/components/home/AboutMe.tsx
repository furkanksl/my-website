    ...
    return (
        <div className="flex flex-col md:flex-row justify-between items-center w-full gap-y-5 md:gap-y-0 gap-x-[40px] lg:gap-x-[120px]">
            ...
            <div className="flex flex-col items-start justify-start w-full z-10">
                ...
                <div className="flex w-full justify-between pt-4 gap-x-1">
                    <div className=" flex justify-start">
                        <a
                            href="https://github.com/furkanksl"
                            target="_blank"
                            referrerPolicy="no-referrer"
                            className="w-min text-neutral-400 text-base md:text-xl font-bold font-rubik uppercase tracking-[2.06px] cursor-pointer hover:scale-110 hover:text-white"
                        >
                            Github
                        </a>
                    </div>
                    ...
                    <div className="flex justify-center items-center">
                        <a
                            ...
                            target="_blank"
                            referrerPolicy="no-referrer"
                            className="w-min whitespace-nowrap text-neutral-400 text-base md:text-xl font-bold font-rubik uppercase tracking-[2.06px] cursor-pointer hover:scale-110 hover:text-white"
                        >
