...
export default function Project(project: ProjectType) {
    ...
    return (
        <div className="flex flex-col gap-y-3 items-center justify-start">
            ...
            >
                <div className="z-20 opacity-0 group-hover:opacity-100 rounded-lg absolute top-0 bottom-0 right-0 left-0 h-full w-full backdrop-blur-md bg-white/5 transition-all delay-150"></div>
